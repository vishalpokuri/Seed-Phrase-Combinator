...
with open("bip39_wordlist.txt", "r") as word_file:
    all_words = [word.strip() for word in word_file.readlines()]

# Known words
known_words = ["ozone", "blast", "link", "bundle", "consider", "rain", "what", "sibling", "x", "y", "z"]

# Generate permutations of 2 words from the list
word_permutations = permutations(all_words, 1)
